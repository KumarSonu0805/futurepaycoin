            <div class="main-deshboard-section">
               <div class="marquee-content">
                  <ul class="marqueeTag">
                     <li>
                        <ul>
                           <li><img src="./images/ethereum.png" alt="ethereum"></li>
                           <li>Ethereum</li>
                           <li class="price">24,866.8</li>
                           <li class="loss">-2,886.5</li>
                        </ul>
                     </li>
                     <li>
                        <ul>
                           <li><img src="./images/ripple.png" alt="bitcoin"></li>
                           <li>Bitcoin</li>
                           <li class="price">52,866.8</li>
                           <li class="profit">+12,886.5</li>
                        </ul>
                     </li>
                     <li>
                        <ul>
                           <li><img src="./images/litecoin.png" alt="litecoin"></li>
                           <li>Litecoin</li>
                           <li class="price">18,866.8</li>
                           <li class="profit">+5,234.2</li>
                        </ul>
                     </li>
                     <li>
                        <ul>
