...
///////////////////////////////////////////////
defined('PROJECT_NAME')        OR define('PROJECT_NAME',"Future Pay Coin"); 
defined('OUR_BRAND')       	   OR define('OUR_BRAND',"");
defined('SITE_SALT')           OR define('SITE_SALT',"Future Pay");
defined('TP')        		   OR define('TP',"fp_"); // Table Prefix
...
if(isset($_SERVER['HTTP_HOST']) && ($_SERVER['HTTP_HOST']=='localhost' || $_SERVER['HTTP_HOST']=='192.168.29.123')){
    ...
    defined('MIN_BAL')              OR define('MIN_BAL',0); //Minimum
    defined('MIN_DEPOSIT')          OR define('MIN_DEPOSIT',0.01); //Minimum Deposit
    defined('ADMIN_ADDRESS')        OR define('ADMIN_ADDRESS','0x409c8270215EDA59923cdCE8Ff6aAe825cf07B22'); //ADMIN Address
...
if(isset($_SERVER['HTTP_HOST']) && $_SERVER['HTTP_HOST']=='localhost'){
    ...
    defined('DB_NAME')          OR define('DB_NAME','db_futurepay'); 
}
else{
    defined('DB_HOST')          OR define('DB_HOST','localhost'); 
    defined('DB_USER')          OR define('DB_USER','u711511560_user_futurepay'); 
    defined('DB_PASS')          OR define('DB_PASS','Futurepay@123#$'); 
    defined('DB_NAME')          OR define('DB_NAME','u711511560_db_futurepay'); 
}
